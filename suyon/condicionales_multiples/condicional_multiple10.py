...
if(compra_total<=300 and compra_total>=250):
    print("estas a punto de ganar un celular nokia 2.1")
if(compra_total<250 and compra_total>100):
    print("tienes un descuento de %41")
#fin_if
