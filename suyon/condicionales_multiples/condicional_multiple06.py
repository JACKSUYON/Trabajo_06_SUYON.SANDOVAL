...
if(area_lateral_cilindro<=34 and area_lateral_cilindro>10):
    print("el area del cilindro es irregular")
if(area_lateral_cilindro<=10):
    print("el area del cilindro es imaginario")
#fin_if
