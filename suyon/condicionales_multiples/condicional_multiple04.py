...
if(total_de_ventas_al_dia<=520 and total_de_ventas_al_dia>500):
    print("eres un vendedor eficiente")
if(total_de_ventas_al_dia<=500 and total_de_ventas_al_dia>400):
    print("eres un trabajador eficaz")
#fin_if
